...
class _fitnessLevelScreenState extends State<fitnessLevelScreen> {
  ...
  Color bu_color = Config.app_light_grey,
      bu_text_color = Colors.black;

  Color lose_bu = Config.app_light_grey,
      lose_bu_text_color = Colors.black;

  Color Gain_bu = Config.app_light_grey,
      Gain_bu_text_color = Colors.black;

  Color Maintaine_bu = Config.app_light_grey,
    ...
    switch (num) {
      case 1:
        if (selectedWeigtEnum == SelectedWeigtEnum.none) {
          ...
          lose_bu = Config.app_backgroungColor;
          lose_bu_text_color = Colors.white;
          Gain_bu = Config.app_light_grey;
          Gain_bu_text_color = Colors.black;
          Maintaine_bu = Config.app_light_grey;
          Maintaine_bu_text_color = Colors.black;
          selectedWeigtEnum = SelectedWeigtEnum.lose;
          changeColor();
        }
  ...
  void changeColor() {
    if (selectedWeigtEnum == SelectedWeigtEnum.none) {
      is_Completed = false;
      bu_color = Config.app_light_grey;
      bu_text_color = Colors.black;
    }
    else {
      is_Completed = true;
  ...
  void didChangeDependencies() {
    ...
    hintText =
        _config.get_text(context, "height_universal_unit_txt").toString();
  }
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text("(1/7)", textAlign: TextAlign.center,
                                style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            _config.get_text(context, "fitness_level_txt"),
                            textAlign: TextAlign.center,
                      ...
                      child: Column(
                        ...
                        children: [
                          GestureDetector(
                              ...
                              child: Container(
                                  child: LanguageSubmitButton(
                                    bu_text: _config.get_text(
                                        context, "fitness_level_bu_1")
                                        .toString(),
                                    bu_color: lose_bu,
                                    textColor: lose_bu_text_color,))),
                          ...
                          GestureDetector(
                              ...
                              child: Container(
                                  child: LanguageSubmitButton(
                                    bu_text: _config.get_text(
                                        context, "fitness_level_bu_2")
                                        .toString(),
                                    bu_color: Gain_bu,
                                    textColor: Gain_bu_text_color,))),
                          ...
                          GestureDetector(
                              ...
                              child: Container(
                                  child: LanguageSubmitButton(
                                    bu_text: _config.get_text(
                                        context, "fitness_level_bu_3")
                                        .toString(),
                                    bu_color: Maintaine_bu,
                                    textColor: Maintaine_bu_text_color,))),
