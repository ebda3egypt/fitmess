...
class weightQuestionScreen extends StatefulWidget {
  bool isEdit;
  weightQuestionScreen(this.isEdit);
  @override
  _weightQuestionScreenState createState() => _weightQuestionScreenState();
}

class _weightQuestionScreenState extends State<weightQuestionScreen> {
                            ...
                            if(is_Completed){
                              if(widget.isEdit){
                                ...
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (BuildContext context) => slideWeightScreen(false)));
                              }
                            }
                          },
                          child: Container(
