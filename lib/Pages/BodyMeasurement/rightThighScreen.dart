...
import 'package:fitmess/Pages/BodyMeasurement/leftThighScreen.dart';
...
class rightThighScreen extends StatefulWidget {
  bool isEdit;
  rightThighScreen(this.isEdit);
  @override
  _rightThighScreenState createState() => _rightThighScreenState();
}

class _rightThighScreenState extends State<rightThighScreen> {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text("(7/8)",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,color:Colors.black)),
                          ],
                        )
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: Center(
                          child:Text(_config.get_text(context, "right_thigh_size_q"),textAlign: TextAlign.center,style: TextStyle(fontSize: 32),),
                        ),
                      ),
                    ),
                    SizedBox(height: 40,),
                          ...
                          if(is_Completed){
                            ...
                            if(widget.isEdit){
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) => leftThighScreen(false)));
                            }
                          }
                        },
                        child: Container(
