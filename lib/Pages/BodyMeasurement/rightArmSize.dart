...
class rightArmScreen extends StatefulWidget {
  bool isEdit;
  rightArmScreen(this.isEdit);
  @override
  _rightArmScreenState createState() => _rightArmScreenState();
}

class _rightArmScreenState extends State<rightArmScreen> {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text("(5/8)",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,color:Colors.black)),
                          ],
                        )
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: Center(
                          child:Text(_config.get_text(context, "right_arm_size_q"),textAlign: TextAlign.center,style: TextStyle(fontSize: 32),),
                        ),
                      ),
                    ),
                    SizedBox(height: 40,),
