import 'package:fitmess/Pages/BodyMeasurement/rightThighScreen.dart';
...
class leftArmSizeScreen extends StatefulWidget {
  bool isEdit;
  leftArmSizeScreen(this.isEdit);
  @override
  _leftArmSizeScreenState createState() => _leftArmSizeScreenState();
}

class _leftArmSizeScreenState extends State<leftArmSizeScreen> {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text("(6/8)",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,color:Colors.black)),
                          ],
                        )
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: Center(
                          child:Text(_config.get_text(context, "left_arm_size_q"),textAlign: TextAlign.center,style: TextStyle(fontSize: 32),),
                        ),
                      ),
                    ),
                    SizedBox(height: 40,),
                          ...
                          if(is_Completed){
                            ...
                            if(widget.isEdit){
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) => rightThighScreen(false)));
                            }
                          }
                        },
                        child: Container(
