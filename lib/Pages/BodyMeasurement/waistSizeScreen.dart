...
import 'package:fitmess/Pages/BodyMeasurement/hipsSizeScreen.dart';
...
class waistSizeScreen extends StatefulWidget {
  bool isEdit;
  waistSizeScreen(this.isEdit);
  @override
  _waistSizeScreenState createState() => _waistSizeScreenState();
}
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text("(3/8)",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,color:Colors.black)),
                          ],
                        )
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: Center(
                          child:Text(_config.get_text(context, "waist_size_q"),textAlign: TextAlign.center,style: TextStyle(fontSize: 32),),
                        ),
                      ),
                    ),
                    SizedBox(height: 40,),
                          ...
                          if(is_Completed){
                            ...
                            if(widget.isEdit){
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) => hipsSizeScreen(false)));
                            }
                          }
                        },
                        child: Container(
