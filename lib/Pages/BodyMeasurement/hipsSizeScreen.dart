import 'package:fitmess/Pages/BodyMeasurement/rightArmSize.dart';
...
class hipsSizeScreen extends StatefulWidget {
  bool isEdit;
  hipsSizeScreen(this.isEdit);
  @override
  _hipsSizeScreenState createState() => _hipsSizeScreenState();
}

class _hipsSizeScreenState extends State<hipsSizeScreen> {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text("(4/8)",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,color:Colors.black)),
                          ],
                        )
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: Center(
                          child:Text(_config.get_text(context, "hips_size_q"),textAlign: TextAlign.center,style: TextStyle(fontSize: 32),),
                        ),
                      ),
                    ),
                    SizedBox(height: 40,),
                          ...
                          if(is_Completed){
                            ...
                            if(widget.isEdit){
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) => rightArmScreen(false)));
                            }
                          }
                        },
                        child: Container(
