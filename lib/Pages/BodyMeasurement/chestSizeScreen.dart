import 'package:fitmess/Pages/BodyMeasurement/waistSizeScreen.dart';
...
class chestSizeScreen extends StatefulWidget {
  bool isEdit;
  chestSizeScreen(this.isEdit);
  @override
  _chestSizeScreenState createState() => _chestSizeScreenState();
}

class _chestSizeScreenState extends State<chestSizeScreen> {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text("(2/8)",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,color:Colors.black)),
                          ],
                        )
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: Center(
                          child:Text(_config.get_text(context, "chest_size_q"),textAlign: TextAlign.center,style: TextStyle(fontSize: 32),),
                        ),
                      ),
                    ),
                    SizedBox(height: 40,),
                          ...
                          if(is_Completed){
                            ...
                            if(widget.isEdit){
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) => waistSizeScreen(false)));
                            }
                          }
                        },
                        child: Container(
