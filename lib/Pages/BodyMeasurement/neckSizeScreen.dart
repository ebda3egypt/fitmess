import 'package:fitmess/Pages/BodyMeasurement/chestSizeScreen.dart';
...
class neckSizeScreen extends StatefulWidget {
  bool isEdit;
  neckSizeScreen(this.isEdit);
  @override
  _weightQuestionScreenState createState() => _weightQuestionScreenState();
}

class _weightQuestionScreenState extends State<neckSizeScreen> {
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5,),
                            Text("(1/8)",textAlign: TextAlign.center,style: TextStyle(fontSize: 16,color:Colors.black)),
                          ],
                        )
                    ...
                    Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: Center(
                          child:Text(_config.get_text(context, "neck_size_q"),textAlign: TextAlign.center,style: TextStyle(fontSize: 32),),
                        ),
                      ),
                    ),
                    SizedBox(height: 40,),
                          ...
                          if(is_Completed){
                            ...
                            if(widget.isEdit){
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) => chestSizeScreen(false)));
                            }
                          }
                        },
                        child: Container(
